...
// Optimized version of finding length of string using recursive.
...
//        Arrays.fill(dp, -1);
//
//        System.out.println("Length = " + ways(str, dp));
//    }
//}


// wap to count zero in the number with recursive or optimization.
public class Dp_recursive {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Zero count = " + ways(n, dp));
    }
}
